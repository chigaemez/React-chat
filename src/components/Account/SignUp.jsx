...
const SignUp = () => {
  ...
  return (
    <div className='flex items-center justify-center w-full  h-screen'>
      <div className='flex flex-col gap-[30px] px-[30px] items-center justify-center w-full max-w-[520px]  py-8 rounded-lg bg-stone-100 text-stone-800'>
        <h1 className='text-2xl font-bold'>SignUp</h1>
        <form className='flex flex-col gap-[24px] w-full items-center justify-between'>
          <div className='flex w-full flex-col'>
            <label htmlFor=''>
              {' '}
              Enter User name <span className='text-red-700'>*</span>
            </label>
            <input
              type='text'
          ...
          <div className='flex w-full flex-col relative'>
            <label htmlFor=''>
              Create a Password <span className='text-red-700'>*</span>
            </label>
            <input
              name='pwd'
          ...
          <div className='flex w-full flex-col relative'>
            <label htmlFor=''>
              Comfirm Password <span className='text-red-700'>*</span>
            </label>
            <input
              name='pwd'
          ...
          <p className='gap-2'>
            ...
            <Link to='/' className='text-[#CF0807] font-extrabold'>
              Sign Up
            </Link>
          </p>
        </form>
